...
class WeisDataset:
    def __init__(self, dataset_folder, test_size=0.2, multi_feature=False):
    ...
    @classmethod
    def from_folder(cls, dataset_folder, test_size=0.2, multi_feature=False):
        return cls(dataset_folder, test_size=test_size, multi_feature=multi_feature)
    ...
    def get_sequence(self, idx):
        ...
        return mask_sequence_flatten.astype(np.float64)
